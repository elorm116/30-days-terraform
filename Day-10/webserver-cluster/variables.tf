...
variable "enable_autoscaling" {
  description = "Whether to create autoscaling policies. Set to false for dev to save costs."
  type        = bool
  default     = true
}

variable "environment" {
  description = "Environment name — controls conditional behaviour inside the module."
  type        = string
  default     = "dev"
}
